...
```<server>:8081/actuator/prometheus``` Prometheus metrics

```<server>:8081/actuator/health/liveness``` Liveness probe

```<server>:8081/actuator/health/readiness``` Readiness probe
